...
class MyContract extends Contract {
    ...
    async addMedicine(ctx, batchId, medicineName, formula, manufacturerLicenseNo, organisationName, owner, address) {
        ...
        medicine.batchId = id;
        medicine.manufacturerLicenseNo = manufacturerLicenseNo;
        medicine.name = medicineName;
        medicine.organisationName = organisationName;
    ...
    //   let medicine = this.query(batchId);
